...
```Bash
python tools/visualizations/browse_dataset.py configs/textrecog/_base_/datasets/icdar2017.py
```
...
```Bash
python tools/visualizations/browse_dataset.py configs/textrecog/_base_/datasets/icdar2017.py -p icdar2015_1811_textrecog_test
```
