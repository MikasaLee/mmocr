...
val_evaluator = dict(
    ...
    # dataset_prefixes=['Casia_Hwdb_2x','SCUT_HccDoc','bnu_EnsExam_ppocrlabel'])
    dataset_prefixes=['bnu_EnsExam_ppocrlabel'])
...
# 令学习率为常量，即不进行学习率衰减
param_scheduler = [dict(type='CosineAnnealingLR', by_epoch=True, T_max=max_epochs, convert_to_iter_based=True,eta_min=0.01)]
optim_wrapper = dict(
    type='OptimWrapper',
