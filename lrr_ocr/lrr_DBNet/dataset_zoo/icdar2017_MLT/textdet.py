data_root = '/lirunrui/datasets/icdar2017_MLT/ICDAR2017_MLT'
...
train_preparer = dict(
    ...
    #     files=[
    #         dict(
    #             url='https://rrc.cvc.uab.es/downloads/ch4_training_images222.zip',
    #             save_name='ic15_textdet_train_img.zip',
    #             md5='c51cbace155dcc4d98c8dd19d378f30d',
    #             content=['image'],
    #             mapping=[['training_images', 'textdet_imgs/train']]),
    #         dict(
