...
launcher = 'none'
load_from = 'work_dirs/dbnet_resnet50-dcnv2_fpnc_1200e_ScutHccdoc/best_icdar_hmean_epoch_758.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir='lrr_ocr/lrr_DBNet/show_results/bnu_EnsExam_ppocrlabel_resnet50',
    type='TextDetLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = './work_dirs/dbnet_resnet50-dcnv2_fpnc_1200e_bnu_EnsExam_ppocrlabel_test'
