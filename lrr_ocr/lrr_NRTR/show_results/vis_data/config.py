...
launcher = 'none'
load_from = 'work_dirs/nrtr_modality-transform_scut_hccdoc_20240410/best_SCUT_HccDoc_recog_AR_epoch_81.pth'
log_level = 'INFO'
...
model = dict(
    ...
    decoder=dict(
        ...
        type='NRTRDecoder'),
    encoder=dict(n_layers=12, type='NRTREncoder'),
    type='NRTR')
optim_wrapper = dict(
...
visualizer = dict(
    name='visualizer',
    save_dir='lrr_ocr/lrr_NRTR/show_results',
    type='TextRecogLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = './work_dirs/nrtr_modality-transform_6e_scut_hccdoc'
