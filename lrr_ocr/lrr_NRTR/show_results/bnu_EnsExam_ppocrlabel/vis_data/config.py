...
launcher = 'none'
load_from = 'work_dirs/nrtr_modality-transform_scut_hccdoc_20240411/best_SCUT_HccDoc_recog_AR_epoch_68.pth'
log_level = 'INFO'
...
model = dict(
    ...
    decoder=dict(
        ...
        type='NRTRDecoder'),
    encoder=dict(is_PE=False, n_layers=12, type='NRTREncoder'),
    type='NRTR')
optim_wrapper = dict(
...
visualizer = dict(
    name='visualizer',
    save_dir='lrr_ocr/lrr_NRTR/show_results/bnu_EnsExam_ppocrlabel',
